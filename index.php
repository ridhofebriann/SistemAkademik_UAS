...
<head>
    ...
    <title>Selamat Datang di Aplikasi Akademik</title>
...
<body>
    ...
    <main>
        <div class="welcome-box">
            <h2>Selamat Datang di Aplikasi Akademik</h2>
            <p>Gunakan navigasi di atas untuk melihat dan mengelola data akademik.</p>
        </div>
    </main>
